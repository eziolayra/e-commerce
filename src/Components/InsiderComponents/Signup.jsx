      ...
      <form className="border-2 border-gray-300 p-10 rounded-md back bg-green-600">
        ...
        <div className="flex gap-2 mt-5">
          ...
          <p className="text-sm text-black">
            By Signing up I have agreed all the{" "}
        ...
        <div className="text-center">
          <button
            type="submit"
            className="pl-6 pr-6 border-2  border-gray-300 p-2 rounded-md mt-12 hover:shadow-md"
          >
            SIGNUP
          </button>
          <button
            type="submit"
            className="pl-6 pr-6 border-2 border-gray-300 p-2 rounded-md mt-12 hover:shadow-md ml-6"
          >
            CANCEL
          </button>
        </div>
